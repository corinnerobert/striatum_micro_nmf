...
working_dir="/data/chamal/projects/corinne/projects/Striatal_NMF/preprocessed/warped/" #MODIFY - DONE
...
all_label_seg_file='/data/chamal/projects/corinne/projects/Striatal_NMF/raw_data/Labels_stri_lookup_table.csv' #MODIFY - DONE
...
df=pd.read_csv('/data/chamal/projects/corinne/projects/Striatal_NMF/raw_data/df_sorted_unrestricted_329.csv') #MODIFY to point to your copy of the demographics file
df_sorted=df
...
compnum=5
hemi='left'
res_dir = '/data/chamal/projects/corinne/projects/Striatal_NMF/analysis/' + \
str(compnum) + 'components/'
if not os.path.exists(res_dir):
    os.makedirs(res_dir)
fname='/data/chamal/projects/corinne/projects/Striatal_NMF/analysis/pnmf_out/' + \
...
lb_ref = "/data/chamal/projects/corinne/projects/Striatal_NMF/preprocessed/warped/final_majority_voted_Lstri_label.nii.gz" #modify, point to a majority vote striatum label
