...
%modify lines below
right_mri_raw = csvread('/data/chamal/projects/corinne/projects/Striatal_NMF/analysis/PLS/pls_inputs/right_brain_spreadsheet.csv',1,2);
...
%zscore manually
mu = mean(right_mri_raw);
sigma = std(right_mri_raw);

z = bsxfun(@minus,right_mri_raw,mu);
